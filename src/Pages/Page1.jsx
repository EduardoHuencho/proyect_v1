          ...
          <div className="flex flex-wrap gap-3">
            {NinosList.map((nino) => (
              <button
                ...
                style={{
                  background:
                    ninoSeleccionado.id === nino.id ? "#1B3A5C" : "transparent",
                  color: ninoSeleccionado.id === nino.id ? "white" : "#1B3A5C",
                  border: "2px solid",
                  borderColor:
                    ninoSeleccionado.id === nino.id ? "#1B3A5C" : "#CBD5E0",
                }}
              >
                ...
                <span
                  ...
                  style={{
                    color:
                      ninoSeleccionado.id === nino.id ? "#FDD835" : "#94A3B8",
                  }}
                >
                  {nino.edad}
                </span>
