  ...
  return (
    ...
    >
      ...
      <div className="max-w-md mx-auto px-6 py-16 flex flex-col items-center">
        ...
        <p className="text-[#4A7A96] mb-12 text-center">
          ¿Qué deseas hacer?
        </p>
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-white/70">Ingreso al menu principal de modulos</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-left">
              <p className="font-extrabold text-lg text-[#E53935]">Cerrar Sesión de Perfil</p>
              <p className="text-sm text-red-400">Volver a selección de niños</p>
            </div>
          </button>
